...
// Console.Write("Введите второе число: ");
// int thridValue = Convert.ToInt32(Console.ReadLine());

// int max = firstValue;

// if (firstValue > max) max = firstValue;
// if (secondValue > max) max = secondValue;
// if (thridValue > max) max = thridValue;
...
// if (number % 2 == 1)
// {
//     Console.WriteLine("Чиcло " + number + " НЕчетное ");
// }
// else 
// {
//     Console.WriteLine("Чиcло " + number + " четное "); 
// }
